...
type MonsterStats struct {
	...
	TreasureClass                 string `csv:"TreasureClass"`                            // Defines which Treasure Class is used by the monster when it is killed. Points to the "Treasure Class" field from the TreasureClassEx.txt file. Used for normal monster types.
	TreasureClassChamp            string `csv:"TreasureClassChamp"`                       // Defines which Treasure Class is used by the monster when it is killed. Points to the "Treasure Class" field from the TreasureClassEx.txt file. Used for Champion monster types.
	TreasureClassUnique           string `csv:"TreasureClassUnique"`                      // Defines which Treasure Class is used by the monster when it is killed. Points to the "Treasure Class" field from the TreasureClassEx.txt file. Used for Unique monster types.
	TreasureClassQuest            string `csv:"TreasureClassQuest"`                       // Defines which Treasure Class is used by the monster when it is killed. Points to the "Treasure Class" field from the TreasureClassEx.txt file. Used for quest related monster drops (See "TCQuestId" and "TCQuestCP").
	TreasureClassDesecrated       string `csv:"TreasureClassDesecrated"`                  // Defines which Treasure Class is used by the monster when it is killed while desecrated (Terrorized). Points to the "Treasure Class" field from the TreasureClassEx.txt file. Used for normal monster types.
	TreasureClassDesecratedChamp  string `csv:"TreasureClassDesecratedChamp"`             // Defines which Treasure Class is used by the monster when it is killed while desecrated (Terrorized). Points to the "Treasure Class" field from the TreasureClassEx.txt file. Used for Champion monster types.
	TreasureClassDesecratedUnique string `csv:"TreasureClassDesecratedUnique"`            // Defines which Treasure Class is used by the monster when it is killed while desecrated (Terrorized). Points to the "Treasure Class" field from the TreasureClassEx.txt file. Used for Unique monster types.
