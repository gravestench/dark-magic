...
func DefaultManifest() Manifest {
	...
	manifest := Manifest{Version: 1, Assets: []Hypothesis{
		{ID: "main-game-select-exp", Screen: "main-menu", Path: "data/global/ui/FrontEnd/gameselectscreenEXP.dc6", Palette: paletteSky, Meaning: "expansion game-select background", References: ref("OpenDiablo2", "AbyssEngine")},
		{ID: "main-title-screen", Screen: "main-menu", Path: "data/global/ui/FrontEnd/TitleScreen.dc6", Palette: paletteSky, Meaning: "title background candidate", References: ref("Riiablo")},
		{ID: "main-trademark-exp", Screen: "main-menu", Path: "data/global/ui/FrontEnd/trademarkscreenEXP.dc6", Palette: "data/global/Palette/trademark/pal.dat", Meaning: "expansion trademark screen", References: ref("OpenDiablo2", "AbyssEngine")},
		{ID: "main-logo-black-left", Screen: "main-menu", Path: "data/global/ui/FrontEnd/D2logoBlackLeft.DC6", Palette: paletteUnits, Meaning: "left opaque logo layer", References: ref("OpenDiablo2", "AbyssEngine", "Riiablo")},
		{ID: "main-logo-fire-left", Screen: "main-menu", Path: "data/global/ui/FrontEnd/D2logoFireLeft.DC6", Palette: paletteUnits, Meaning: "left luminous animated logo layer", References: ref("OpenDiablo2", "AbyssEngine", "Riiablo")},
		{ID: "main-logo-black-right", Screen: "main-menu", Path: "data/global/ui/FrontEnd/D2logoBlackRight.DC6", Palette: paletteUnits, Meaning: "right opaque logo layer", References: ref("OpenDiablo2", "AbyssEngine", "Riiablo")},
		{ID: "main-logo-fire-right", Screen: "main-menu", Path: "data/global/ui/FrontEnd/D2logoFireRight.DC6", Palette: paletteUnits, Meaning: "right luminous animated logo layer", References: ref("OpenDiablo2", "AbyssEngine", "Riiablo")},
		...
		{ID: "button-3wide", Screen: "front-end-common", Path: "data/global/ui/FrontEnd/3WideButtonBlank.dc6", Palette: paletteUnits, Meaning: "three-wide blank button states", References: ref("Riiablo")},
		{ID: "button-medium", Screen: "front-end-common", Path: "data/global/ui/FrontEnd/MediumButtonBlank.dc6", Palette: paletteUnits, Meaning: "medium blank button states", References: ref("OpenDiablo2", "Riiablo")},
		...
		{ID: "loading-global", Screen: "loading", Path: "data/global/ui/Loading/loadingscreen.dc6", Palette: paletteLoading, Meaning: "global loading progress frames", References: ref("OpenDiablo2", "AbyssEngine")},
		{ID: "loading-local", Screen: "loading", Path: "data/local/ui/loadingscreen.dc6", Palette: paletteLoading, Meaning: "local loading progress frames candidate", References: ref("Riiablo")},
		{ID: "hud-control-panel", Screen: "game-hud", Path: "data/global/ui/PANEL/800ctrlpnl7.dc6", Palette: paletteSky, Meaning: "800x600 control panel pieces", References: ref("OpenDiablo2", "Riiablo")},
		...
		{ID: "hud-mini-buttons", Screen: "game-hud", Path: "data/global/ui/PANEL/minipanelbtn.DC6", Palette: paletteSky, Meaning: "mini-panel button state pairs", References: ref("OpenDiablo2", "Riiablo")},
		{ID: "inventory-character", Screen: "inventory", Path: "data/global/ui/PANEL/invchar6.DC6", Palette: paletteSky, Meaning: "character inventory panel", References: ref("OpenDiablo2", "Riiablo")},
		{ID: "inventory-weapon-tabs", Screen: "inventory", Path: "data/global/ui/PANEL/invchar6Tab.DC6", Palette: paletteSky, Meaning: "alternate weapon tabs", References: ref("OpenDiablo2", "Riiablo")},
		{ID: "inventory-buy-sell-button", Screen: "inventory", Path: "data/global/ui/PANEL/buysellbtn.DC6", Palette: paletteSky, Meaning: "inventory and vendor button states", References: ref("OpenDiablo2", "Riiablo")},
	...
	manifest.Assets = append(manifest.Assets,
		Hypothesis{ID: "inventory-armor-slot", Screen: "inventory", Path: "data/global/ui/PANEL/inv_armor.DC6", Palette: paletteSky, Meaning: "armor equipment placeholder", References: ref("OpenDiablo2", "Riiablo")},
		Hypothesis{ID: "inventory-belt-slot", Screen: "inventory", Path: "data/global/ui/PANEL/inv_belt.DC6", Palette: paletteSky, Meaning: "belt equipment placeholder", References: ref("OpenDiablo2", "Riiablo")},
		Hypothesis{ID: "inventory-boots-slot", Screen: "inventory", Path: "data/global/ui/PANEL/inv_boots.DC6", Palette: paletteSky, Meaning: "boots equipment placeholder", References: ref("OpenDiablo2", "Riiablo")},
		Hypothesis{ID: "inventory-helm-glove-slot", Screen: "inventory", Path: "data/global/ui/PANEL/inv_helm_glove.DC6", Palette: paletteSky, Meaning: "helm and glove equipment placeholders", References: ref("OpenDiablo2", "Riiablo")},
		Hypothesis{ID: "inventory-ring-amulet-slot", Screen: "inventory", Path: "data/global/ui/PANEL/inv_ring_amulet.DC6", Palette: paletteSky, Meaning: "ring and amulet equipment placeholders", References: ref("OpenDiablo2", "Riiablo")},
		Hypothesis{ID: "inventory-weapons-slot", Screen: "inventory", Path: "data/global/ui/PANEL/inv_weapons.DC6", Palette: paletteSky, Meaning: "weapon equipment placeholders", References: ref("OpenDiablo2", "Riiablo")},
		Hypothesis{ID: "records-inventory", Screen: "inventory", Path: "data/global/excel/Inventory.txt", Meaning: "class inventory and equipment geometry", References: ref("OpenDiablo2", "Riiablo")},
		Hypothesis{ID: "records-sounds", Screen: "audio", Path: "data/global/excel/Sounds.txt", Meaning: "sound handles, files, groups, channels, and playback metadata", References: ref("OpenDiablo2", "Riiablo")},
		...
		Hypothesis{ID: "records-skill-description", Screen: "skills", Path: "data/global/excel/SkillDesc.txt", Meaning: "skill icon cells and localized description keys", References: ref("OpenDiablo2", "Riiablo")},
		Hypothesis{ID: "audio-title-introedit", Screen: "main-menu", Path: "data/global/music/introedit.wav", Meaning: "title music candidate", References: ref("OpenDiablo2", "AbyssEngine")},
		Hypothesis{ID: "audio-title-diablo", Screen: "main-menu", Path: "data/global/music/Act4/diablo.wav", Meaning: "title music candidate", References: ref("Riiablo")},
		Hypothesis{ID: "audio-button", Screen: "front-end-common", Path: "data/global/sfx/cursor/button.wav", Meaning: "button interaction sound", References: ref("Riiablo")},
		Hypothesis{ID: "audio-select", Screen: "front-end-common", Path: "data/global/sfx/cursor/select.wav", Meaning: "selection confirmation sound", References: ref("Riiablo")},
		Hypothesis{ID: "video-blizzard", Screen: "startup", Path: "data/local/video/New_Bliz640x480.bik", Meaning: "Blizzard startup video", References: ref("AbyssEngine")},
		Hypothesis{ID: "video-blizzard-north", Screen: "startup", Path: "data/local/video/BlizNorth640x480.bik", Meaning: "Blizzard North startup video", References: ref("AbyssEngine")},
	)
	return manifest
}
