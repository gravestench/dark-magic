...
func semanticCheckpoint() simulation.Checkpoint {
	...
	return simulation.Checkpoint{Tick: 100, Snapshot: &gameecs.Snapshot{Version: gameecs.SnapshotVersion, Tick: 100, Entities: []uint64{player, caster, target, 20, 21, 22, 23, 24}, Components: []gameecs.ComponentSnapshot{
		...
		component("d2legacy.presentation.effect_cue", []string{"kind", "tick", "target", "overlay_id", "sound"},
			gameecs.InstanceSnapshot{Entity: 24, Values: []gameecs.ValueSnapshot{stringValue("state_reaction"), intValue(100), entityValue(target), stringValue("frozenarmor_hit"), stringValue("")}}),
