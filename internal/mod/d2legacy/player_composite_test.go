...
func TestRealArchivesComposeUnarmedPlayerModes(t *testing.T) {
	...
	scope := &Scope{}
	if err := runtime.ExecuteScoped(context.Background(), scope, content.D2Legacy(), "lua/d2legacy/tests/integration/player_composite_real.lua"); err != nil {
		t.Fatal(err)
	}
	...
	secondScope := &Scope{}
	if err := runtime.ExecuteScoped(context.Background(), secondScope, content.D2Legacy(), "lua/d2legacy/tests/integration/player_composite_real.lua"); err != nil {
		t.Fatal(err)
	}
