...
// TestDrawIntoChunksAllocatesOnlyIntersectedChunks protects sparse allocation for maps much larger than the viewport.
...
// TestDrawIntoChunksPreservesPixelsAcrossBoundary verifies clipping does not shift pixels split between adjacent cells.
...
// TestDrawIntoChunksClipsOutsideCanvas ensures off-map placements cannot allocate invalid negative chunk coordinates.
...
// TestDrawIntoTightChunksPreservesMapCoordinatesAcrossBoundary checks compact storage retains absolute map origins.
...
// TestTrimTransparentMarginsPreservesWorldOrigin protects the transform correction required after removing empty
// pixels.
