...
// TestCollisionDiamondIncludesItsProjectedCenter verifies authoritative subtile projection lands inside its marker.
...
// TestCollisionRegionUsesAuthoritativeMapCanvasCoordinates protects overlay alignment with retained tile nodes.
