...
// TestCubicCurvesAreNormalizedAndMonotonic protects the endpoint and ordering
// guarantees animation callers rely on when mapping normalized progress.
...
// TestCubicInOutMidpoint guards the exact join between the curve's two branches.
