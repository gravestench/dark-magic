...
type InventoryData struct {
	...
	// InvRight is the ending X coordinate pixel position of the inventory panel (Includes the "InvLeft" value with the
	// inventory width size).
	InvRight int `csv:"invRight"`

	// InvTop is the starting Y coordinate pixel position of the inventory panel.
	InvTop int `csv:"invTop"`

	// InvBottom is the ending Y coordinate pixel position of the inventory panel (Includes the "InvTop" value with the
	// inventory height size).
	...
	// GridRight is the ending X coordinate location of the inventory's right grid side (Includes the "GridLeft" value with
	// the grid width size).
	...
	// GridBottom is the ending Y coordinate location of the inventory's bottom grid side (Includes the "GridTop" value
	// with the grid height size).
	...
	// RArmRight is the ending X coordinate location of the Right Weapon Slot (Includes the "RArmLeft" value with the
	// "RArmWidth" value).
	...
	// RArmBottom is the ending Y coordinate location of the Right Weapon Slot (Includes the "RArmTop" value with the
	// "RArmHeight" value).
	...
	// TorsoRight is the ending X coordinate location of the Body Armor Slot (Includes the "TorsoLeft" value with the
	// "TorsoWidth" value).
	...
	// TorsoBottom is the ending Y coordinate location of the Body Armor Slot (Includes the "TorsoTop" value with the
	// "TorsoHeight" value).
	...
	// LArmRight is the ending X coordinate location of the Left Weapon Slot (Includes the "LArmLeft" value with the
	// "LArmWidth" value).
	...
	// LArmBottom is the ending Y coordinate location of the Left Weapon Slot (Includes the "LArmTop" value with the
	// "LArmHeight" value).
	...
	// HeadRight is the ending X coordinate location of the Helm Slot (Includes the "HeadLeft" value with the "HeadWidth"
	// value).
	...
	// HeadBottom is the ending Y coordinate location of the Helm Slot (Includes the "HeadTop" value with the "HeadHeight"
	// value).
	...
	// NeckRight is the ending X coordinate location of the Amulet Slot (Includes the "NeckLeft" value with the "NeckWidth"
	// value).
	...
	// NeckBottom is the ending Y coordinate location of the Amulet Slot (Includes the "NeckTop" value with the
	// "NeckHeight" value).
	...
	// RHandRight is the ending X coordinate location of the Right Ring Slot (Includes the "RHandLeft" value with the
	// "RHandWidth" value).
	...
	// RHandBottom is the ending Y coordinate location of the Right Ring Slot (Includes the "RHandTop" value with the
	// "RHandHeight" value).
	...
	// LHandRight is the ending X coordinate location of the Left Ring Slot (Includes the "LHandLeft" value with the
	// "LHandWidth" value).
	...
	// LHandBottom is the ending Y coordinate location of the Left Ring Slot (Includes the "LHandTop" value with the
	// "LHandHeight" value).
	...
	// BeltRight is the ending X coordinate location of the Belt Slot (Includes the "BeltLeft" value with the "BeltWidth"
	// value).
	...
	// BeltBottom is the ending Y coordinate location of the Belt Slot (Includes the "BeltTop" value with the "BeltHeight"
	// value).
	...
	// FeetRight is the ending X coordinate location of the Boots Slot (Includes the "FeetLeft" value with the "FeetWidth"
	// value).
	...
	// FeetBottom is the ending Y coordinate location of the Boots Slot (Includes the "FeetTop" value with the "FeetHeight"
	// value).
	...
	// GlovesRight is the ending X coordinate location of the Gloves Slot (Includes the "GlovesLeft" value with the
	// "GlovesWidth" value).
	...
	// GlovesBottom is the ending Y coordinate location of the Gloves Slot (Includes the "GlovesTop" value with the
	// "GlovesHeight" value).
