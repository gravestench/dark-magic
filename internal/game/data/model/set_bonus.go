...
type SetBonusData struct {
	...
	// Controls the each of the different pairs of Partial Set item properties. These are applied when the player has
	// equipped the related # of Set items.
	PCode2a string `csv:"PCode2a"`
	PCode3a string `csv:"PCode3a"`
	PCode4a string `csv:"PCode4a"`
	PCode5a string `csv:"PCode5a"`

	// The stat's "parameter" value associated with the relative property (PCode#a). Usage depends on the property function
	...
	// The stat's "min" value associated with the listed relative (PCode#a). Usage depends on the property function (See
	...
	// The stat's "max" value to assign to the listed relative (PCode#a). Usage depends on the property function (See the
	...
	// The stat's "parameter" value associated with the relative property (PCode#b). Usage depends on the property function
	// (See the "func" field on Properties.txt)
	...
	// The stat's "min" value associated with the listed relative (PCode#b). Usage depends on the property function (See
	// the "func" field on Properties.txt)
	...
	// The stat's "max" value to assign to the listed relative (PCode#b). Usage depends on the property function (See the
	// "func" field on Properties.txt)
	...
	// Controls the each of the different Full Set item properties. These are applied when the player has all Set item
	// pieces equipped.
	...
	// The stat's "parameter" value associated with the relative property (FCode#b). Usage depends on the property function
	// (See the "func" field on Properties.txt)
	...
	// The stat's "min" value associated with the listed relative (FCode#b). Usage depends on the property function (See
	// the "func" field on Properties.txt)
	FMin1 int `csv:"FMin1"`
	FMin2 int `csv:"FMin2"`
	FMin3 int `csv:"FMin3"`
	...
	// The stat's "max" value to assign to the listed relative (FCode#b). Usage depends on the property function (See the
	// "func" field on Properties.txt)
	FMax1 int `csv:"FMax1"`
	FMax2 int `csv:"FMax2"`
	FMax3 int `csv:"FMax3"`
