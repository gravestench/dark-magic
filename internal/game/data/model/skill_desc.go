...
type SkillDescData struct {
	...
	// Icon asset for displaying the skill on a hireable (mercenary).
	HireableIconCel string `csv:"HireableIconCel"`
	...
	// Integer calc value used as a parameter for DescDam function.
	DDamCalc1 string `csv:"ddam calc1"`
	// Integer calc value used as a parameter for DescDam function.
	DDamCalc2    string `csv:"ddam calc2"`
	...
	// Description function ID for level and next level tooltip lines.
	DescLine1 string `csv:"descline1"`
	// Description function ID for level and next level tooltip lines.
	DescLine2 string `csv:"descline2"`
	// Description function ID for level and next level tooltip lines.
	DescLine3 string `csv:"descline3"`
	// Description function ID for level and next level tooltip lines.
	DescLine4 string `csv:"descline4"`
	// Description function ID for level and next level tooltip lines.
	DescLine5 string `csv:"descline5"`
	// Description function ID for level and next level tooltip lines.
	DescLine6  string `csv:"descline6"`
	...
	// Description function ID for pinned lines after skill description.
	Dsc2Line1 string `csv:"dsc2line1"`
	// Description function ID for pinned lines after skill description.
	Dsc2Line2 string `csv:"dsc2line2"`
	// Description function ID for pinned lines after skill description.
	Dsc2Line3 string `csv:"dsc2line3"`
	// Description function ID for pinned lines after skill description.
	Dsc2Line4 string `csv:"dsc2line4"`
	// Description function ID for pinned lines after skill description.
	Dsc2Line5  string `csv:"dsc2line5"`
	...
	// Description function ID for pinned lines at the bottom of the skill tooltip.
	Dsc3Line1 string `csv:"dsc3line1"`
	// Description function ID for pinned lines at the bottom of the skill tooltip.
	Dsc3Line2 string `csv:"dsc3line2"`
	// Description function ID for pinned lines at the bottom of the skill tooltip.
	Dsc3Line3 string `csv:"dsc3line3"`
	// Description function ID for pinned lines at the bottom of the skill tooltip.
	Dsc3Line4 string `csv:"dsc3line4"`
	// Description function ID for pinned lines at the bottom of the skill tooltip.
	Dsc3Line5 string `csv:"dsc3line5"`
	// Description function ID for pinned lines at the bottom of the skill tooltip.
	Dsc3Line6 string `csv:"dsc3line6"`
	// Description function ID for pinned lines at the bottom of the skill tooltip.
	Dsc3Line7  string `csv:"dsc3line7"`
	...
	// Override format for skill appearing as "chance to cast" on an item.
	ItemProcText string `csv:"item proc text"`
	// Number of descline entries formatted into ItemProcText string.
	ItemProcDescLine string `csv:"item proc descline count"`
}
