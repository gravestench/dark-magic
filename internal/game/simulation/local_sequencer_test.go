...
// TestLocalSequencerCombinesIndependentProducersPerPlayer preserves one canonical sequence across local sources.
...
// TestLocalSequencerDoesNotMutateProducerSlice protects producer-owned command buffers from hidden writes.
