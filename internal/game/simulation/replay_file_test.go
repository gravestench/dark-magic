...
// TestReplayContainerFileRoundTripsWithPrivatePermissions protects persisted evidence from broad file access.
...
// TestReplayContainerFileDoesNotReplaceExistingFileWhenEncodingFails protects the last valid replay on failure.
