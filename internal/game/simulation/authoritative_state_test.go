...
// TestAuthoritativeStateStoreSnapshotsRestoresAndRejectsSchemaDrift protects atomic restore and fixed schemas.
...
// TestRuntimeIdentityRejectsDifferentAuthoritativeCode ensures replay cannot silently switch rule implementations.
...
// runtimeIdentityFixture returns a complete valid identity while allowing tests to vary package provenance.
