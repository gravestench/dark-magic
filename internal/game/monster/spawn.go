...
type stores struct {
	identity, stats, appearance, position, velocity, location, collider, selectable *akara.DynamicStore
}
...
func registerStores(world *akara.World) (stores, error) {
	...
	return stores{registered[0], registered[1], registered[2], registered[3], registered[4], registered[5], registered[6], registered[7]}, nil
}
