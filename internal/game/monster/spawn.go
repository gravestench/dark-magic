...
func registerStores(world *akara.World) (stores, error) {
	schemas := []akara.Schema{
		{Name: "d2legacy.monster.identity", Version: 2, Fields: []akara.Field{{Name: "spawn_id", Kind: akara.FieldString}, {Name: "definition_id", Kind: akara.FieldString}, {Name: "base_id", Kind: akara.FieldString}, {Name: "graphics_id", Kind: akara.FieldString}, {Name: "seed", Kind: akara.FieldString}, {Name: "treasure_class", Kind: akara.FieldString}}},
		{Name: "d2legacy.monster.stats", Version: 1, Fields: []akara.Field{{Name: "level", Kind: akara.FieldInt64}, {Name: "health", Kind: akara.FieldInt64}, {Name: "max_health", Kind: akara.FieldInt64}, {Name: "defense", Kind: akara.FieldInt64}, {Name: "attack_rating", Kind: akara.FieldInt64}, {Name: "physical_min", Kind: akara.FieldInt64}, {Name: "physical_max", Kind: akara.FieldInt64}, {Name: "experience", Kind: akara.FieldInt64}}},
		...
		{Name: "d2legacy.monster.appearance", Version: 3, Fields: []akara.Field{{Name: "token", Kind: akara.FieldString}, {Name: "mode", Kind: akara.FieldString}, {Name: "weapon_class", Kind: akara.FieldString}, {Name: "name_key", Kind: akara.FieldString}, {Name: "components", Kind: akara.FieldString}, {Name: "death_sound", Kind: akara.FieldString}}},
		aiSchema(),
...
// representation without teaching Akara about maps. Lua decodes this short
// comma-separated recipe at the presentation boundary.
func encodeComponents(components map[string]string) string {
	...
	for _, key := range keys {
		parts = append(parts, key+"="+components[key])
	}
