...
const (
	...
	BasicAttackRequest = "d2legacy.combat.basic_attack_request"
	MeleeProfile       = "d2legacy.combat.melee_profile"
	BasicAttackReceipt = "d2legacy.combat.basic_attack_receipt"
	CombatEvent        = "d2legacy.combat.event"
