...
// footprintWalkable samples the circular entity footprint around a continuous position. A nil map remains unrestricted
// for prediction contexts that intentionally run without authoritative collision.
...
// clampMovement confines one axis to entity-radius-adjusted bounds before collision sampling.
