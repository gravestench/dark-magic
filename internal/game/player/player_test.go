...
func TestAdmissionCommandCarriesDurableFactsWithoutInterpretingD2Policy(t *testing.T) {
	character := persistence.Character{ID: "hero", Name: "Hero", Class: "Amazon", Level: 3, Expansion: true,
		Stats: &persistence.Stats{Dexterity: 20, Defense: 7, Experience: 100, Health: 25, MaxHealth: 30, Mana: 12, MaxMana: 15}}
