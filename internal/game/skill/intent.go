...
const (
	...
	CastRequestComponent   = "dm.skill.cast_request"
)
...
func registerIntentStores(engine *gameecs.Engine) (intents, controls, learned, requests *akara.DynamicStore, err error) {
	schemas := []akara.Schema{
		...
		{Name: "dm.player.learned_skill", Version: 1, Fields: []akara.Field{{Name: "owner", Kind: akara.FieldEntity}, {Name: "skill_id", Kind: akara.FieldInt64}, {Name: "level", Kind: akara.FieldInt64}, {Name: "list_row", Kind: akara.FieldInt64}, {Name: "left_allowed", Kind: akara.FieldBool}, {Name: "right_allowed", Kind: akara.FieldBool}}},
		castRequestSchema(),
	}
