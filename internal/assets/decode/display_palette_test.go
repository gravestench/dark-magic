...
// TestDisplayPaletteAcceptsTinyRawAndJSONPalettes verifies every supported
// format, including deliberately small mod palettes and GPL metadata rows.
...
// TestDisplayPaletteRejectsMalformedGPL covers structural and numeric failures
// that must not be mistaken for ignorable names or comments.
