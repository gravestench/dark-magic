...
// NewPackageRegistry constructs package registry with its dependencies in one place, keeping ownership and
// cleanup explicit.
...
// Replace owns the replace step at this boundary, keeping its side effects and failure point explicit to callers.
...
// owner owns the owner step at this boundary, keeping its side effects and failure point explicit to callers.
...
// PackageRequireRegistry owns the package require registry step at this boundary, keeping its side effects and
