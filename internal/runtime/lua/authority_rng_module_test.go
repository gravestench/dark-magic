...
// TestAuthorityRandomModuleUsesCheckpointedNamedStreams protects the authority random module uses checkpointed
// named streams contract, including its observable ordering and failure behavior.
...
// TestAuthorityRandomModuleRejectsUnregisteredPurpose protects the authority random module rejects unregistered
// purpose contract, including its observable ordering and failure behavior.
