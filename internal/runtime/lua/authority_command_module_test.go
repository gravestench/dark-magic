...
// TestAuthorityCommandModuleKeepsAdmissionInGoAndPolicyInLua protects the authority command module keeps admission
// in go and policy in lua contract, including its observable ordering and failure behavior.
...
// TestAuthorityCommandLuaValidatorRejectsBeforeQueueing protects the authority command lua validator rejects before
// queueing contract, including its observable ordering and failure behavior.
...
// TestAuthorityCommandFailureRollsBackLuaOwnedState protects the authority command failure rolls back lua owned
// state contract, including its observable ordering and failure behavior.
