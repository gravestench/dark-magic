...
func WorldgenModule() Module {
	return Module{
		...
		Help: documentedModule("Validate and canonicalize immutable mod-authored world recipes.", map[string]CommandHelp{
			"admit": commandHelp("engine.worldgen.admit(definition)", "Validate a recipe and return its canonical snapshot and checksum."),
		}),
