...
--   d2legacy.ui.escape_menu = reusable menu pages/controls/pentagram visuals
--   engine.settings/v1           = actual settings values/persistence
--   engine.scene/v1              = actual navigation stack
--
