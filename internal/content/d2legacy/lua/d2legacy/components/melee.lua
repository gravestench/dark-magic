...
function M.register()
    ecs.component({name="d2.combat.basic_attack_request", fields={
        {name="target_id",type="string"},{name="request_tick",type="i64"},
    }})
    ecs.component({name="d2.combat.melee_profile", fields={
    ...
    ecs.component({name="d2.skill.cast_event", fields={
