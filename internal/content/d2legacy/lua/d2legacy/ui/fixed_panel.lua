...
local item_grid = require("d2legacy.ui.item_grid")
local item_slots = require("d2legacy.ui.item_slots")
...
local function inventory_record(grid)
    ...
    -- asset-backed item path therefore does not need engine.records/v1 installed.
