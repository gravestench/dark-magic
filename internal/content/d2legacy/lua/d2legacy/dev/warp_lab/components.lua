...
function M.register()
    ...
    ecs.component({name="d2legacy.world.position", version=1, fields={field("x","f64"),field("y","f64")}})
    ecs.component({name="d2legacy.lab.warp.portal", version=1, fields={
        field("id","string"), field("pair","entity"), field("label","string"), field("radius","f64"),
    }})
    ecs.component({name="d2legacy.lab.warp.intent", version=1, fields={
        field("portal","entity"), field("route","string"), field("waypoint","i64"),
    }})
    ecs.component({name="d2legacy.lab.warp.move_intent", version=1, fields={
        field("x", "f64"), field("y", "f64"), field("route","string"), field("waypoint","i64"),
    }})
    ecs.component({name="d2legacy.lab.warp.actor", version=1, fields={
        field("speed", "f64"), field("direction", "i64"),
    }})
    ecs.component({name="d2legacy.lab.warp.state", version=1, fields={
