...
local function decode(skill, missiles)
    ...
    return {
        ...
        impact_loop = false,
        impact_sound = "",
        effect_duration_base = 0,
        effect_duration_per_level = 0,
        effect_duration_synergy_skill_ids = {},
        effect_duration_synergy_percent_per_level = 0,
        on_hit_state_id = "",
        on_hit_state_duration_policy = "",
        on_hit_state_action_disabled = false,
