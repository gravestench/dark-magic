    ...
    cases = {
        test.case("loads_exact_target_locked_family_ids", function(t)
            t:run(function()
                ...
                test.expect(coverage.by_family["aura.selected-party-stat"][4]):equals(105)
                test.expect(coverage.by_family["aura.selected-party-stat"][5]):equals(108)
                test.expect(coverage.by_family["aura.selected-party-stat"][6]):equals(110)
                test.expect(coverage.by_family["aura.selected-party-stat"][7]):equals(115)
                test.expect(coverage.by_family["aura.selected-party-stat"][8]):equals(125)
