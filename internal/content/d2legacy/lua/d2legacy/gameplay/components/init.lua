...
local modules = {
    require("d2legacy.gameplay.components.player_identity"),
    require("d2legacy.gameplay.components.player_animation"),
    require("d2legacy.gameplay.components.player_skills"),
    require("d2legacy.gameplay.components.player_belt"),
    require("d2legacy.gameplay.components.world_spatial"),
}
