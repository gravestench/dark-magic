...
return {
    ...
    enter = function(self)
        ...
        text.create(self.root, "disabled", assert(locale.text("d2.party.unavailable")), screen.unavailable.x + offset_x, screen.unavailable.y + offset_y, screen.unavailable.width)
