...
// TestResolvePresentationProfile pins explicit profile dimensions, screen scope, and rejection of unknown profiles.
func TestResolvePresentationProfile(t *testing.T) {
	...
	if profile.ID != "classic" || profile.Width != 640 || profile.Height != 480 ||
		!reflect.DeepEqual(profile.ScreenIDs, []string{"game_world"}) {
