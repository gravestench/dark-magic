...
// TestD2LegacyArchiveMatchesEmbeddedTreeAndIsDeterministic pins both archive completeness and reproducible bytes.
func TestD2LegacyArchiveMatchesEmbeddedTreeAndIsDeterministic(t *testing.T) {
	// Independent writes catch timestamps, iteration order, or compressor state leaking into distribution output.
