...
func TestPresentationBootstrapComesFromManifest(t *testing.T) {
	const manifest = `{"schema":"d2legacy.presentation/v1","palettes":{"loading":"palette.dat"},"screens":{"title":{"background":"title.dc6"},"game_loading":{"sheet":"loading.dc6","palette":"loading"},"game_world":{"map":{"ds1":"town.ds1","dt1":["floor.dt1"]}}}}`
	source := fstest.MapFS{
