...
local modules = {
    require("darkmagic.gameplay.components.player_identity"),
    require("darkmagic.gameplay.components.player_animation"),
    require("darkmagic.gameplay.components.player_skills"),
    require("darkmagic.gameplay.components.player_belt"),
    require("darkmagic.gameplay.components.world_spatial"),
}
