...
function M.register()
    ecs.component({name="dm.combat.basic_attack_request", fields={
        {name="target_id",type="string"},{name="request_tick",type="i64"},
    }})
    ecs.component({name="dm.combat.melee_profile", fields={
    ...
    ecs.component({name="dm.skill.cast_event", fields={
