...
return {
    ...
    enter = function(self)
        ...
        text.create(self.root, "panel_heading", assert(locale.text("d2.help.title")), heading.x, heading.y, heading.width)
        ...
        for index, key in ipairs(bullets) do
            ...
            text.create(self.root, "formal_large", assert(locale.text("d2.help." .. key)), 100, y, content.text_width, "left")
        end
