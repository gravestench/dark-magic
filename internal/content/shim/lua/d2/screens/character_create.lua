...
local ui_button = require("d2.ui.button")
local ui_checkbox = require("d2.ui.checkbox")
local ui_text_field = require("d2.ui.text_field")
local cursor = require("d2.ui.cursor")
local text = require("d2.ui.text")
local compat = require("d2.ui.compat")
local preload = require("d2.ui.preload")
    ...
    create = function(self)
        ...
        self.show_class_copy = function(definition)
            ...
            position_text_from_top(
                ...
                assert(locale.text("d2.character_class." .. class_id .. ".name")),
                recovered.class_name
            )
            position_text_from_top(
                self.class_description,
                screen.labels.description.style,
                assert(locale.text("d2.character_class." .. class_id .. ".description")),
