...
--   d2.gameplay.world -> ECS binding + camera helper
...
local game_hud = require("d2.ui.game_hud")
local player_composite = require("d2.gameplay.player_composite")
local monster_composite = require("d2.gameplay.monster_composite")
local missile_presentation = require("d2.gameplay.missile_presentation")
...
return {
    create = function(self)
        ...
        self.gameplay_world = require("d2.gameplay.world")
