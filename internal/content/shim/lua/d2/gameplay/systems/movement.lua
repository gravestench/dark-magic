...
local function update_entity(entity, collision, elapsed)
    ...
    local bounds = ecs.get(entity, "d2.world.bounds")
...
function M.register(collision)
    ...
    ecs.system({
        ...
        phase = "movement",
        query = { all = { "d2.world.position", "d2.world.velocity", "d2.world.bounds", "d2.world.collider" } },
        read = { "d2.world.velocity", "d2.world.bounds", "d2.world.collider" },
