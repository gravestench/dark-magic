...
14. `darkmagic/screens/composite_lab.lua`, `monster_lab.lua`, `missile_lab.lua`, `combat_lab.lua`, `dt1_lab.lua`, `ds1_lab.lua`, and `mapgen_lab.lua` — asset-backed animation, authoritative combat, tile, map, and generated-zone inspection scenes.
