...
// TestMemoryCheckpointsValidateIdentityMonotonicityAndCopies verifies memory checkpoints validate identity
// monotonicity and copies. The scenario keeps the checkpoint repository contract visible to maintainers.
...
// TestGameCheckpointRejectsTamperingAndWrongRuntime verifies game checkpoint rejects tampering and wrong runtime. The
// scenario keeps the checkpoint repository contract visible to maintainers.
