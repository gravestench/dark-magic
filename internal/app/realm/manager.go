...
// NewManager constructs the manager boundary and validates dependencies before callers can publish or mutate shared
// state.
...
// Allocate coordinates allocate through the owning manager synchronization boundary so shared state is published only
...
// Game coordinates game through the owning manager synchronization boundary so shared state is published only after a
// complete transition.
...
// Release coordinates release through the owning manager synchronization boundary so shared state is published only
// after a complete transition.
...
// Close coordinates close through the owning manager synchronization boundary so shared state is published only after
