...
// TestMemoryMembershipDepartureCommitsOnceAndRetainsReceipt verifies memory membership departure commits once and
// retains receipt. The scenario keeps the membership repository contract visible to maintainers.
...
// TestMemoryMembershipsAllowDifferentCharactersFromSameAccount verifies memory memberships allow different characters
// from same account. The scenario keeps the membership repository contract visible to maintainers.
...
// TestMemoryMembershipResumeRenewsActiveLease verifies memory membership resume renews active lease. The scenario
// keeps the membership repository contract visible to maintainers.
