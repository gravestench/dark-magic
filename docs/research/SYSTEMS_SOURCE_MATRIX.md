...
| [Blizzard Diablo II version-history text and archived patch announcements](https://classic.battle.net/diablo2exp/beta/readme.shtml) | release line 1.01-1.14d; official 1.10 beta pages remain live, other announcements survive unevenly through archives and reproductions | first-party public release notes | B for documented feature introduction/removal and intended user-visible deltas; not proof of exhaustive final behavior, formulas, ordering, or server internals | cumulative patch chronology, Classic/Expansion distinctions, feature introduction/removal windows, exploit and compatibility changes; centralized in [DIABLO_II_PATCH_HISTORY.md](DIABLO_II_PATCH_HISTORY.md) |
| [Basin Wiki patch history](https://theamazonbasin.com/wiki/index.php/Patch) | live page inspected 2026-08-18; chronology corroborated against archived/contemporary sources | community compilation of historical first-party notes | C for reproduced notes and chronology; individual claims remain subject to the underlying source | most complete accessible 1.01-1.14d changelog index, dates, 1.10 beta/final distinction, server-side content activation, and links to surviving contemporary sources |
| [Codex Gamicus Diablo II changelog](https://gamicus.fandom.com/wiki/Diablo_II/Changelog) | live index inspected 2026-08-18 | CC BY-SA community compilation | D discovery; C only where independently corroborated | separate changelog pages for Classic and LoD patches 1.01-1.12; inventory cross-check |
| [MobyGames Diablo II](https://www.mobygames.com/game/1878/diablo-ii/patches/) and [Lord of Destruction](https://www.mobygames.com/game/4451/diablo-ii-lord-of-destruction/patches/) patch listings | live listings inspected 2026-08-18 | proprietary community database metadata | D chronology corroboration | Windows/Mac package chronology, dates, public beta and platform-variant inventory |
| [JudgeHype Diablo II patch archive](https://diablo2.judgehype.com/patch104/) | contemporary 1.04/1.04b/1.04c page inspected 2026-08-18 | historical community reporting; linked patch assets remain Blizzard material | C for contemporary chronology and reproduced hotfix description | establishes the easily omitted 1.04c optional PC CD/DVD hotfix and distinguishes it from the 1.04 gameplay release |
| [GameSpot contemporary Diablo II reporting](https://www.gamespot.com/articles/diablo-ii-patched/1100-2595553/) | 27 Jun 2000 launch-patch report inspected 2026-08-18 | proprietary press archive | C for contemporary chronology | corroborates that 1.01 was a day-one update prepared before the retail street date; not behavioral authority beyond the linked/reported notes |
| [AusGamers Diablo II file archive](https://www.ausgamers.com/files/browsegame/html/3/9/downloads) | live file index inspected 2026-08-18 | proprietary historical download index; patch payload rights remain with Blizzard | D package-inventory corroboration | records platform-specific packages including the Macintosh 1.08b updater and public 1.10 beta |
| [Diablo2.DiabloWiki 1.13 patch history](https://diablo2.diablowiki.net/Diablo_2_Patch_Notes_1.13) | live page inspected 2026-08-18 | community wiki | D discovery; C only where independently corroborated | corroborates the 1.13a/1.13b PTR-to-1.13c production sequence and resolves the otherwise impossible secondary-source date ordering |
| [ChaosMarc/D2VersionChanger](https://github.com/ChaosMarc/D2VersionChanger) | `master` inspected 2026-08-18 | repository-specific; packaged game binaries/assets are not evidence to copy | D inventory/tooling lead only | independently catalogs switchable Classic 1.00 through LoD 1.14d builds and distinguishes rare/beta/platform variants; not behavioral authority |
