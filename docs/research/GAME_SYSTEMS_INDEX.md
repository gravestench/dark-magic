...
| 23 | Movement, collision, pathfinding, and room streaming | [MOVEMENT_COLLISION_AND_PATHFINDING.md](MOVEMENT_COLLISION_AND_PATHFINDING.md) | baseline | pointer-first movement, medium footprint, deterministic A*, DT1 collision, diagnostics, first zone seam, and type-independent persistent-identity room activation exist; exact 1.14d policy and production residency attachment remain | world, timing, monsters | 25 |
