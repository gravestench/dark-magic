...
| 17 | Multiplayer parties, hostility, trading, and shared progress | [MULTIPLAYER_PARTIES_PVP_AND_TRADE.md](MULTIPLAYER_PARTIES_PVP_AND_TRADE.md) | baseline | checkpointed invite/cancel/accept/leave party authority, same-level living-member queries, departure cleanup, and reconnect continuity exist; reward, UI, hostility, and trade consumers remain | session + items + quests + combat | queued probes |
