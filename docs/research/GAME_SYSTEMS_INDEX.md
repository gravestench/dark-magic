...
| 12 | Combat, damage, defense, and death | [COMBAT_DAMAGE_AND_DEATH.md](COMBAT_DAMAGE_AND_DEATH.md) | baseline | G8 separates generic attack outcomes from damage commitment, shares one ordered direct-damage result across melee/missile contact, preserves six rolled/mitigated channels, and gives death attribution an independent consumer marker; exact Expansion 1.14d block/avoid arithmetic, remaining consumers, drain/durations, and combat/death stages stay probe-gated | stats, timing, skills, items | 17 |
...
- G8 combat fidelity tranche 1: active; shared direct-damage commit/result and
  ...
  into one diagnostic record. Block/avoidance, ordered combat-family breadth,
