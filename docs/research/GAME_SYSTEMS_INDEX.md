...
| 11 | Skills, missiles, states, and combat actions | [SKILLS_STATES_AND_MISSILES.md](SKILLS_STATES_AND_MISSILES.md) | baseline | M21.6 immutable cast requests and M21.7 checkpointed cast lifecycle are implemented; straight/radial/area-impact/on-hit-state missile families use ordinary ECS composition, Fire Bolt/Fire Ball snapshot modifiers, and Ice Blast routes nonlethal freeze through timed-state/action filters while exact resistance/class/PvP ordering remains probe-gated | timing, stats, combat, missiles/states | 22 |
