...
| 23 | Movement, collision, pathfinding, and room streaming | [MOVEMENT_COLLISION_AND_PATHFINDING.md](MOVEMENT_COLLISION_AND_PATHFINDING.md) | baseline | pointer-first movement, deterministic A*, DT1 collision, and type-independent room activation now cover owned-unit graphs, corpses, straight projectiles, and first imported ground-item attachment/pickup/re-drop transitions; exact 1.14d policy plus stateful-object/pending-action residency remain | world, timing, monsters | 25 |
