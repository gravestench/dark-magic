...
| 12 | Combat, damage, defense, and death | [COMBAT_DAMAGE_AND_DEATH.md](COMBAT_DAMAGE_AND_DEATH.md) | baseline | G8 now shares one explicit ordered direct-damage commit/result across melee and missile contact; composed ECS events preserve generic and melee-specific consumers, while exact Expansion 1.14d arithmetic and remaining combat/death stages stay probe-gated | stats, timing, skills, items | 17 |
...
- G8 combat fidelity tranche 1: active; shared direct-damage commit/result
  implemented, ordered combat-family breadth and player death remain.
