...
| 12 | Combat, damage, defense, and death | [COMBAT_DAMAGE_AND_DEATH.md](COMBAT_DAMAGE_AND_DEATH.md) | baseline | G8 now shares one explicit ordered direct-damage commit/result across melee and missile contact; its composed ECS bundle preserves six rolled/mitigated channels independently, while exact Expansion 1.14d arithmetic, drain/durations, and remaining combat/death stages stay probe-gated | stats, timing, skills, items | 17 |
...
- G8 combat fidelity tranche 1: active; shared direct-damage commit/result and
  typed six-channel ECS stage facts implemented, ordered combat-family breadth,
  drain/durations, and player death remain.
