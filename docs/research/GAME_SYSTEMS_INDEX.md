...
| 12 | Combat, damage, defense, and death | [COMBAT_DAMAGE_AND_DEATH.md](COMBAT_DAMAGE_AND_DEATH.md) | baseline | G8 now shares one explicit ordered direct-damage commit/result across melee and missile contact; its composed ECS bundle preserves six rolled/mitigated channels, and death attribution consumes only the generic result through an independent marker, while exact Expansion 1.14d arithmetic, remaining consumers, drain/durations, and combat/death stages stay probe-gated | stats, timing, skills, items | 17 |
...
- G8 combat fidelity tranche 1: active; shared direct-damage commit/result and
  ...
  independent ECS consumer marker. Ordered combat-family breadth, remaining
  consumers/retirement, drain/durations, and player death remain.
